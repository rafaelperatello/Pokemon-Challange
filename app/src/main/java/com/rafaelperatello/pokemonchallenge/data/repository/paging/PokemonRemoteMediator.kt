...
internal class PokemonRemoteMediator(
    ...
    override suspend fun initialize(): InitializeAction {
        return if (pokemonDao.getCount() == 0) {
    ...
    override suspend fun load(
    ...
    ): MediatorResult = withContext(ioContext) {
        ...
        val (page, pageSize) =
            when (loadType) {
                ...
                LoadType.APPEND -> {
                    val currentPage = state.anchorPosition?.let { anchorPosition ->
...
//                    } ?: throw IllegalStateException("Anchor position is null") // Todo revert
        ...
        Log.d("PokemonPaging", "MEDIATOR - page: $page, pageSize: $pageSize, netWorkResult: $netWorkResult")
